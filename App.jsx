...
const App = () => {
  ...
  // テキスト状態
  const [mainText, setMainText] = useState('キャラクター名');
  const [subText, setSubText] = useState('ハンドアウト');
  const [systemName, setSystemName] = useState('システム名');
  const [scenarioTitle, setScenarioTitle] = useState('シナリオタイトル');
